...
//    lcd.print("TEM SENSOR ERROR     ");
  ...
  if(tempC<val)
  {
      ...
      if(tempC<(val-int(EEPROM.read(14))))
      {
        buzzer=1;
  ...
  {
      if(tempC>(val+int(EEPROM.read(13))))
      {
        buzzer=1;
      tone(speaker,5000, 50);
      }
